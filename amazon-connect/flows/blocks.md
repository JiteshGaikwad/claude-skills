...
| **Set routing criteria** | Defines agent routing criteria (required/preferred attributes, expiration). | Voice, Chat, Task | Attribute-based routing. Agents must match criteria. Steps expire and relax over time. |
